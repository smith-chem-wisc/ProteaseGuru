...
public static class IntegerTextBounds
{
    ...
    /// a number at all (a lone "-", or a programmatic assignment) resolves to the nearest valid
    /// value rather than being left unparseable.
    /// </summary>
    public static string Clamp(string? text, int lowerBound, int upperBound)
    {
        ...
        return Math.Clamp(0, lowerBound, upperBound).ToString(CultureInfo.InvariantCulture);
    }
}
